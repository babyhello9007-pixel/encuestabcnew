-- ============================================================================
-- SCRIPT SQL PARA SUPABASE - ENCUESTA BC (Versión UUID)
-- ============================================================================
-- Este script crea todas las tablas necesarias para el sistema de encuestas
-- Compatible con UUID (como en resultados_encuestas existente)
...
CREATE TABLE IF NOT EXISTS public.encuestas_externas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  encuestadora_id UUID NOT NULL REFERENCES public.encuestadoras(id) ON DELETE CASCADE,
...
-- ============================================================================
-- 3. ACTUALIZAR TABLA: RESULTADOS_ENCUESTAS (Survey Results)
-- ============================================================================
-- Si la tabla ya existe, agregar la FK a encuestas_externas
-- Si no existe, crearla
CREATE TABLE IF NOT EXISTS public.resultados_encuestas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  encuesta_id UUID NOT NULL REFERENCES public.encuestas_externas(id) ON DELETE CASCADE,

...
export const PARTIES_GENERAL = {
  ...
  ALIANZA: { name: 'Aliança Catalana', logo: '/assets/icons/aliançacatalana.png' },
...
export const YOUTH_ASSOCIATIONS = {
  ...
  NNGG: { name: 'Nuevas Generaciones del PP', logo: '/assets/icons/Nuevas Generaciones del PP.png' },
  JVOX: { name: 'Jóvenes de VOX', logo: '/assets/icons/Jóvenes De VOX.png' },
  VLE: { name: 'Voces Libres España (VLE)', logo: '/assets/icons/VocesLibresDeEspaña.jpg' },
  JSE: { name: 'Juventudes Socialistas de España', logo: '/assets/icons/Juventudes Socialistas de España.png' },
  ...
  JCS: { name: 'Jóvenes de Ciudadanos', logo: '/assets/icons/jóvenesdeciudadanos.jpg' },
  EGI: { name: 'EGI', logo: '/assets/icons/egi.jpg' },
  ERNAI: { name: 'Ernai', logo: '/assets/icons/ernai.jpg' },
  JERC: { name: "Joventuts d'Esquerra Republicana de Catalunya", logo: '/assets/icons/Joventuts d\'Esquerra Republicana de Catalunya.png' },
  JNC: { name: 'Joventut Nacionalista de Catalunya', logo: '/assets/icons/Joventut Nacionalista de Catalunya.png' },
  ...
  ACL: { name: 'Acción Castilla y León', logo: '/assets/icons/AcciónCastillay León.png' },

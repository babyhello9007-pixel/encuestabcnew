...
export const PARTIES_GENERAL = {
  ...
  ALIANZA: { name: 'Aliança Catalana', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/LSGJuMLqKLfIuSBC.png', color: '#003D99' },
  BILDU: { name: 'BILDU', logo: '/assets/icons/ehbildu.png', color: '#00AA44' },
  SAF: { name: 'Se Acabó La Fiesta', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/pVOVNQaSxYeSVYyR.png', color: '#FF6600' },
  ...
  AA: { name: 'Adelante Andalucía', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/tTkePaUFEpyBEbYg.png', color: '#FF0000' },
  CUP: { name: 'CUP', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/qlFqJHJrlRttAYmH.png', color: '#FFC400' },
  PACMA: { name: 'PACMA', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/hDwYeFmKiKHHhgZI.png', color: '#00AA44' },
  PCTE: { name: 'PCTE', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/OxYlERpqIvuYLNIC.png', color: '#CC0000' },
  UPL: { name: 'UPL', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/mwmmLxCMDbZacPQT.png', color: '#0066FF' },
  RECORTESCERO: { name: 'RecortesCero', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/flLSuaHeOIjYDIve.jpg', color: '#FF0000' },
  FI: { name: 'Frente de Izquierdas', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/flLSuaHeOIjYDIve.jpg', color: '#CC0000' },
  PE: { name: 'Por España', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/LfhcjcOgngqwFaRh.png', color: '#0066FF' },
  NN: { name: 'Núcleo Nacional', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/cxzxAKrYdmopDhFQ.png', color: '#FF0000' },
  AE: { name: 'Aragón Existe', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/WYyKtKyxSmCkVtuk.png', color: '#FFD700' },
  CHA: { name: 'Chunta Aragonesista', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/YgTqCeiHToEqDmlL.png', color: '#003D99' },
  PA: { name: 'Por Andalucía', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/CeQBGvSmlrncUwYs.png', color: '#FF0000' },
};

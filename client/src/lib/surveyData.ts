...
export const YOUTH_ASSOCIATIONS = {
  ...
  JVOX: { name: 'Jóvenes de VOX', logo: '/assets/icons/JóvenesDeVOX.png' },
  VLE: { name: 'Voces Libres España (VLE)', logo: '/assets/icons/VocesLibresDeEspaña.jpg' },
  JSE: { name: 'Juventudes Socialistas de España', logo: '/assets/icons/JuventudesSocialistasdeEspaña.png' },
  ...
  JERC: { name: "Joventuts d'Esquerra Republicana de Catalunya", logo: '/assets/icons/Joventutsd\'EsquerraRepublicanadeCatalunya.png' },
  JNC: { name: 'Joventut Nacionalista de Catalunya', logo: '/assets/icons/JoventutNacionalistadeCatalunya.png' },

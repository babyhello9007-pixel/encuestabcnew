...
export const YOUTH_ASSOCIATIONS = {
  ...
  JVOX: { name: 'Jóvenes de VOX', logo: '/assets/icons/JovenesDeVoxNEW.png' },
  VLE: { name: 'Voces Libres España (VLE)', logo: '/assets/icons/VocesLibresEspanaNEW.jpg' },
  JSE: { name: 'Juventudes Socialistas de España', logo: '/assets/icons/JuventudesSocialistasEspanaNEW.png' },
  ...
  ACL: { name: 'Acción Castilla y León', logo: '/assets/icons/AccionCastillaLeonNEW.png' },
  JEC: { name: 'Juventud Estudiante Católica', logo: '/assets/icons/JuventudEstudianteCatolicaNEW.jpg' },

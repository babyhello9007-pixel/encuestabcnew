...
export const PARTIES_GENERAL = {
  ...
  ERC: { name: 'ERC', logo: '/assets/icons/ERCNew.png' },
  ...
  UPN: { name: 'UPN', logo: '/assets/icons/UPNNew.png' },
...
export const YOUTH_ASSOCIATIONS = {
  SHAACABAT: { name: "S'ha Acabat!", logo: '/assets/icons/shaacabat7.jpg' },
  REVUELTA: { name: 'Revuelta', logo: '/assets/icons/RevueltaNEW.jpg' },
  NNGG: { name: 'Nuevas Generaciones del PP', logo: '/assets/icons/nngg.png' },
  ...
  JIU: { name: 'Juventudes de Izquierda Unida', logo: '/assets/icons/jiu.jpg' },
  JCOMUNISTA: { name: 'Juventudes Comunistas', logo: '/assets/icons/jcomunista.png' },

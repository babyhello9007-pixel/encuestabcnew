...
export const PARTIES_GENERAL = {
  PP: { name: 'PP', logo: '/assets/icons/PP.png', color: '#0066CC' },
  PSOE: { name: 'PSOE', logo: '/assets/icons/PSOE.png', color: '#E81828' },
  VOX: { name: 'VOX', logo: '/assets/icons/VOX.png', color: '#24AA3D' },
  SUMAR: { name: 'SUMAR', logo: '/assets/icons/SUMAR.png', color: '#9B2D96' },
  PODEMOS: { name: 'PODEMOS', logo: '/assets/icons/PODEMOS.png', color: '#6B2D8C' },
  JUNTS: { name: 'JUNTS', logo: '/assets/icons/JUNTS.png', color: '#003399' },
  ERC: { name: 'ERC', logo: '/assets/icons/ERCNew.png', color: '#FFC400' },
  PNV: { name: 'PNV', logo: '/assets/icons/PNV.png', color: '#00AA44' },
  ...
  UPN: { name: 'UPN', logo: '/assets/icons/UPNNew.png', color: '#0066CC' },
  ...
  BNG: { name: 'Bloque Nacionalista Galego', logo: '/assets/icons/bng.png', color: '#003D99' },
...
export const YOUTH_ASSOCIATIONS = {
  ...
  REVUELTA: { name: 'Revuelta', logo: '/assets/icons/RevueltaNEW.jpg' },
  NNGG: { name: 'Nuevas Generaciones del PP', logo: '/assets/icons/NuevasGeneracionesdelPP.png' },
  JVOX: { name: 'Jóvenes de VOX', logo: '/assets/icons/JóvenesDeVOXNEW.png' },
  VLE: { name: 'Voces Libres España (VLE)', logo: '/assets/icons/VocesLibresDeEspañaNEW.jpg' },
  JSE: { name: 'Juventudes Socialistas de España', logo: '/assets/icons/JuventudesSocialistasdeEspañaNEW.png' },
  ...
  JCS: { name: 'Jóvenes de Ciudadanos', logo: '/assets/icons/jóvenesdeciudadanosNEW.jpg' },
  EGI: { name: 'EGI', logo: '/assets/icons/egi.jpg' },
  ERNAI: { name: 'Ernai', logo: '/assets/icons/ernai.jpg' },
  JERC: { name: "Joventuts d'Esquerra Republicana de Catalunya", logo: '/assets/icons/ERCNew.png' },
  JNC: { name: 'Joventut Nacionalista de Catalunya', logo: '/assets/icons/JoventutNacionalistadeCatalunyaNEW.png' },
  GALIZANOVA: { name: 'Galiza Nova', logo: '/assets/icons/galizanovanew.png' },
  ARRAN: { name: 'Arran', logo: '/assets/icons/arran-new.png' },
  ...
  ACL: { name: 'Acción Castilla y León', logo: '/assets/icons/AcciónCastillayLeónNEW.png' },
  JEC: { name: 'Juventud Estudiante Católica', logo: '/assets/icons/JuventudEstudianteCatólicaNEW.jpg' },

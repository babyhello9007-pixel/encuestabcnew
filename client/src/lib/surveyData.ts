...
export const PARTIES_GENERAL = {
  ...
  ALIANZA: { name: 'Aliança Catalana', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/zCCULukIrHXPLszz.png', color: '#003D99' },
  BILDU: { name: 'BILDU', logo: '/assets/icons/ehbildu.png', color: '#00AA44' },
  SAF: { name: 'Se Acabó La Fiesta', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/YARlIyWhQUtmhSJU.png', color: '#FF6600' },
  ...
  AA: { name: 'Adelante Andalucía', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/wXvZZaeDyPMGFEoT.png', color: '#FF0000' },
  CUP: { name: 'CUP', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/zOnMOkaASHvSdnHO.png', color: '#FFC400' },
  PACMA: { name: 'PACMA', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/oFPiRXIjLEtCIcTK.png', color: '#00AA44' },
  PCTE: { name: 'PCTE', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/aAEflBGDWMxqNQzg.png', color: '#CC0000' },
  UPL: { name: 'UPL', logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663194390516/hgpgXntVgyzaNdQp.png', color: '#0066FF' },

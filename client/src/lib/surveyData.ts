...
export const YOUTH_ASSOCIATIONS = {
  ...
  JVOX: { name: 'Jóvenes de VOX', logo: '/assets/icons/Jóvenes De VOXNEW.png' },
  VLE: { name: 'Voces Libres España (VLE)', logo: '/assets/icons/VocesLibresDeEspañaNEW.jpg' },
  JSE: { name: 'Juventudes Socialistas de España', logo: '/assets/icons/Juventudes Socialistas de EspañaNEW.png' },
  ...
  JNC: { name: 'Joventut Nacionalista de Catalunya', logo: '/assets/icons/Joventut Nacionalista de CatalunyaNEW.png' },
  ...
  ACL: { name: 'Acción Castilla y León', logo: '/assets/icons/AcciónCastillay LeónNEW.png' },
...
export const LEADERS = {
  FEIJOO: { name: 'Alberto Núñez Feijóo', image: '/assets/icons/AlbertoNuñezFeijoo.png' },

...
export const YOUTH_ASSOCIATIONS = {
  ...
  REVUELTA: { name: 'Revuelta', logo: '/assets/icons/RevueltaNEW.jpg', color: '#6B1B47' },
  NNGG: { name: 'Nuevas Generaciones del PP', logo: '/assets/icons/NuevasGeneracionesdelPP.png', color: '#0066CC' },
  JVOX: { name: 'Jóvenes de VOX', logo: '/assets/icons/JóvenesDeVOXNEW.png', color: '#24AA3D' },
  VLE: { name: 'Voces Libres España (VLE)', logo: '/assets/icons/VocesLibresDeEspañaNEW.jpg', color: '#FFD700' },
  JSE: { name: 'Juventudes Socialistas de España', logo: '/assets/icons/JuventudesSocialistasdeEspañaNEW.png', color: '#E81828' },
  ...
  JEC: { name: 'Juventud Estudiante Católica', logo: '/assets/icons/JuventudEstudianteCatólicaNEW.jpg', color: '#0066CC' },
